...
export async function fetchPublicNews(params?: NewsQueryParams) {
  const response = await publicApi.get<PaginatedResponse<News>>('/news', {
    params,
  })
...
export async function fetchNews(params?: NewsQueryParams) {
  const response = await protectedApi.get<PaginatedResponse<News>>('/news', {
    params,
  })
  return response.data
}
...
export async function fetchMyNews(params?: NewsQueryParams) {
  const response = await protectedApi.get<PaginatedResponse<News>>('/news/my', {
    params,
  })
  return response.data
}
