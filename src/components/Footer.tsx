    ...
    <footer className="bg-linear-65 from-red-950 to-red-700 text-gray-200">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm mt-4">
              Defendendo os direitos e promovendo o bem-estar dos trabalhadores
              portuários de Rio Grande desde sua fundação.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  href="mailto:contato@estivadoresriogrande.org.br"
                  className="text-gray-400 hover:text-white transition-colors"
                >
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400 text-sm">
          <p>
            &copy; {currentYear} BDSystems. Todos os direitos reservados.
            Sindicato dos Estivadores e dos Trabalhadores em Carvão e Mineral de
