...
export function NewsForm({ initialData, isEditing = false }: NewsFormProps) {
  ...
  const tagSuggestions = [
    ...
    'Benefícios', 'Jurídico', 'Saúde', 'Trabalho', 'Educação'
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Resumo <span className="text-destructive">*</span></FormLabel>
                  <FormControl>
                    <Textarea 
                  ...
                  <FormDescription>
                    O resumo será exibido nos cards de notícias e nas visualizações prévias.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Conteúdo <span className="text-destructive">*</span></FormLabel>
                  <FormControl>
